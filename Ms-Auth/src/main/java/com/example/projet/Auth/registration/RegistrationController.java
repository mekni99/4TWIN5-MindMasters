...
import com.example.projet.Auth.event.RegistrationCompleteEvent;
import com.example.projet.Auth.event.listener.RegistrationCompleteEventListener;
import com.example.projet.Auth.registration.password.PasswordRequestUtil;
...
import com.example.projet.Auth.user.UserService;
...
public class RegistrationController {
    ...
    private String passwordResetEmailLink(User user, String applicationUrl,
        ...
        String url = applicationUrl+"/newpassword?token="+passwordToken;
